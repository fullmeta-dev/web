...
((nil
  . ((fill-column . 78)
     ...
     (eval . (progn
               ...
               (cl-case system-type
                 (darwin nil)
                 ;; TODO replace me with either gnu/linux or whatever in guix
                 (otherwise
		        ...
		        (require 'cl-lib)
		        (dolist (path (list
				       "/home/vlad/.config/guix/current/lib/guile/3.0/site-ccache"
				       "/home/vlad/.config/guix/current/share/guile/site/3.0"
				       root-dir*))
		          (cl-pushnew path geiser-guile-load-path :test #'string-equal)))))))))))
 ...
 (scheme-mode
  .
  (;;(geiser-connection-timeout . guix-geiser-connection-timeout)
